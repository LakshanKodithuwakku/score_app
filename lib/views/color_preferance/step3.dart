...
class _Step3State extends State<Step3> {
  ...
  Future<void> _sendDataToFirestore(int score, int reactionTime, double color_score, String color_name) async {
    try {
      ...
      await firestore.collection('color_preferance').doc(widget.userId).collection('step3').doc(widget.userId).set({
        'time_score': score,
  ...
  void playAudioInstruction() async {
    ...
    await flutterTts.speak('Choose orange color');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Choose Orange Colour'),
      ),
      body: Container(
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        ...
                        double color_score = checkAnswer(Colors.orange);
                        String color_name = getColorName(Colors.orange);
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Step4(userId: userId)),
                        );
                      },
                      child: Container(
                        color: Colors.orange,
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        int score = calculateTimeScore(_secondsElapsed);
                        int reactionTime = _secondsElapsed;
                        double color_score = checkAnswer(Colors.pinkAccent);
                        String color_name = getColorName(Colors.pinkAccent);
