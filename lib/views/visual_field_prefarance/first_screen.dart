...
import 'package:score_app/views/visual_field_prefarance/second_screen.dart';
...
class _FirstScreenState extends State<FirstScreen> {
  ...
  Future<void> _sendDataToFirestore(int score, int reactionTime) async {
    try {
      ...
      await firestore.collection('visual_field_preference').doc(widget.userId).collection('1st_screen').doc(widget.userId).set({
        'score': score,
